        ...
        <div className="d-flex flex-column h-100">
            <main className="flex-shrink-0">
                ...
                <Container className="howto-section">
                    <PlainContent>
                        <h2><strong>SOLITAIRE100 COOKIE POLICY</strong></h2>
                        <p><strong>Last updated December 08, 2019</strong></p>
                        <p>This Cookie Policy explains how SOLITAIRE100 ("<strong>Company</strong>", "<strong>we</strong>", "<strong>us</strong>", and "<strong>our</strong>") uses cookies and similar technologies to recognize you when you visit our websites at https://solitaire100.com, ("<strong>Websites</strong>"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
                        ...
                        <h5><strong>Why do we use cookies?</strong></h5>
                        ...
                        <h5><strong>How can I control cookies?</strong></h5>
                        ...
                        <h5><strong>Essential website cookies:</strong></h5>
                        ...
                        <h5><strong>What about other tracking technologies, like web beacons?</strong></h5>
                        ...
                        <h5><strong>Do you use Flash cookies or Local Shared Objects?</strong></h5>
                        ...
                        <h5><strong>Do you serve targeted advertising?</strong></h5>
                        ...
                        <h5><strong>How often will you update this Cookie Policy?</strong></h5>
                        <p>We may update this Cookie Policy from time to time in order to reflect, for example, changes to the cookies we use or for other operational, legal or regulatory reasons. Please therefore re-visit this Cookie Policy regularly to stay informed about our use of cookies and related technologies. </p>
                        <p>The date at the top of this Cookie Policy indicates when it was last updated.</p>
                        <h5><strong>Where can I get further information?</strong></h5>
                        <p>If you have any questions about our use of cookies or other technologies, please email us at solitaire.100@outlook.com.</p>
                    </PlainContent>
                </Container>
            </main>
            <Footer />
